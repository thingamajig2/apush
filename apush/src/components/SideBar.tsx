...
export const SideBar: React.FC<SideBarProps> = ({
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-full w-80 bg-[#fffaeb] p-4 border-r z-40 transform transition-transform duration-300 ease-in-out overflow-auto pb-5
        ${isOpen ? "translate-x-0" : "-translate-x-full"}
        md:static md:translate-x-0 md:h-screen md:w-96 md:block`}
    >
